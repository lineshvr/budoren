...
<html>
 <head>
    ...
    <h3>Gjenoppretting av passord</h3>
    
Velg et passord
Vennligst velg et passord som er lett å huske, men vanskelig å gjette!
...
<tr>
	...
	<tr>
		...
		<td style="width: 6%" class="auto-style2"> </td>
			<td style="width: 10%"><input name="recoverypassword" type="submit" value="Registrer">&nbsp;&nbsp;&nbsp;&nbsp;
