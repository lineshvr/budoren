...
$sql_orderdata ="SELECT * FROM film_data RIGHT JOIN orderdata ON (orderdata.film_id = film_data.film_id) order by orderdate desc";
...
//printf("Current character set: %s\n", $mysqli->character_set_name());
	...
	<?php
		...
		$itemList=array();
			...
			echo("<th style=\"width: 2%\">".'Orderedliste'."</th>");
			$itemList[]='Orderedstatus';
...
echo "<td style=\"width: 2%\" class=\"tdstyle\"><a href=\"shipmenthistory_new.php?orderid=$row[8]\">KlickHer</a></ td>";
